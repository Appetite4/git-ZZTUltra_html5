...
<?php
		if ($width >= 960) {
			echo '<TD class="SCROLL_L_2"><EMPTY/></TD>';
			echo '<TD class="SCROLL_M_2"><EMPTY/></TD>';
			echo '<TD class="SCROLL_R_2"><EMPTY/></TD>';
			echo '</TR><TR>';
			echo '<TD class="SCROLL_V_2"><EMPTY/></TD>';
		}
		else
		{
			echo '<TD class="SCROLL_L"><EMPTY/></TD>';
			echo '<TD class="SCROLL_M"><EMPTY/></TD>';
			echo '<TD class="SCROLL_R"><EMPTY/></TD>';
			echo '</TR><TR>';
			echo '<TD class="SCROLL_V"><EMPTY/></TD>';
		}
?>
		<TD>
		<!-- Begin main -->
...
<?php
		if ($width >= 960) {
			echo '<TD class="SCROLL_V2_2"><EMPTY/></TD></TR><TR>';
			echo '<TD class="SCROLL_L_2"><EMPTY/></TD>';
			echo '<TD class="SCROLL_M_2"><EMPTY/></TD>';
			echo '<TD class="SCROLL_R_2"><EMPTY/></TD>';
		}
		...
		{
			echo '<TD class="SCROLL_V2"><EMPTY/></TD></TR><TR>';
			echo '<TD class="SCROLL_L"><EMPTY/></TD>';
			echo '<TD class="SCROLL_M"><EMPTY/></TD>';
			echo '<TD class="SCROLL_R"><EMPTY/></TD>';
		}
